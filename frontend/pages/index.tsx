    ...
    <div>
      ...
      <header className="bg-white">
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-1 items-center justify-end xmd:justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                ...
                <Link
                  className="xhidden rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-indigo-600 transition hover:text-indigo-600/75 sm:block"
                  href="/login"
                >
                  Sign in
                </Link>
      ...
      >
        <ul className="space-y-1 px-4 py-4 text-sm">
          <li>
            <a
              href="#"
              className="block rounded-lg px-3 py-2 text-gray-500 hover:bg-gray-50"
            >
              Product
            </a>
          </li>
        ...
        <div className="p-8 md:p-12 lg:px-16 lg:py-24">
          <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
            ...
            <p className="hidden text-gray-500 md:mt-4 md:block">
              Orbitly brings your tasks, docs, and conversations into a single
              workspace, so your team spends less time switching tools and more
              time shipping work.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-gray-500 sm:text-xl">
              From five-person startups to hundred-person companies, teams
              switch to Orbitly to keep everyone moving in the same direction.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-lg text-center">
            ...
            <p className="mt-4 text-lg text-pretty text-gray-700">
              Built for fast-moving teams who need structure without the
              busywork.
            </p>
          </div>
              ...
              <div className="col-span-2">
                <div>
                  ...
                  <p className="mt-4 text-gray-500">
                    New features, integrations, and best practices from the
                    Orbitly team, sent once a month.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 border-t border-gray-100 pt-8">
            <div className="sm:flex sm:justify-between">
              <p className="text-xs text-gray-500">
                &copy; 2026. Orbitly. All rights reserved.
              </p>
